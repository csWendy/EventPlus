...
public class TicketMasterClient2 {
	...
	private static final String API_KEY = "un8HRByPuIRAOOw6TVzy8EA005smXg5G";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			connection.setRequestMethod("GET");// default, can skip
			connection.connect();// can skip
			...
			// get response body
			// 分段分包返回when the response body is long
			// reader.read();
